...
public class Model implements VariableDefinitions {
    ...
    public void createQuestions(StatefulKnowledgeSession ksession, Model model) {		
        ...
        questions.add(new Question("hasLeasedLand", YESNO, ksession, "Leased u ook land?", ASK, model));  
    		// If yes
        	questions.add(new Question("leasedLandSize", NUMB, ksession, "Hoe groot is het land dat u leased?", DONTASK, model));
        ...
        questions.add(new Question("Has Shed", YESNO, ksession, "Bent u in het bezit van een schuur?", ASK, model));    
    		...
    		// If shedTooSmall
    		questions.add(new Question("isAllowedToBuild", YESNO, ksession, "Heeft u de mogelijkheid om u schuur uit te breiden (zowel fysiek als wettelijk)", DONTASK, model));
